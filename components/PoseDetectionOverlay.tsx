...
export default function PoseDetectionOverlay({ visible, onClose, exerciseName, onRepCount }: PoseDetectionOverlayProps) {
    ...
    const drawSkeleton = useCallback((
        ...
        for (const [startIdx, endIdx] of POSE_CONNECTIONS) {
            ...
            ctx.strokeStyle = `rgba(218, 0, 35, ${alpha})`;
            ctx.beginPath();
        ...
        for (const idx of JOINT_INDICES) {
            ...
            // Neon glow ring
            ctx.strokeStyle = `rgba(218, 0, 35, ${vis * 0.6})`;
            ctx.lineWidth = 2;
            ctx.beginPath();
                ...
                <div style={{ position: 'relative', width: '100%', aspectRatio: '4/3' }}>
                    ...
                    {overlayState === 'loading' && (
                        ...
                        >
                            ...
                            <span style={{ color: '#da0023', fontSize: '0.85rem' }}>
                    ...
                    {overlayState === 'active' && (
                        <>
                            ...
                            >
                                ...
                                />
                                <span style={{ color: '#da0023', fontSize: '0.7rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                                    Form Check
                                </span>
                            </div>
                            ...
                            <div
                                ...
                                style={{
                                    ...
                                    border: '1px solid rgba(218, 0, 35, 0.5)',
                                    borderRadius: '12px',
                                    padding: '4px 14px',
                                    display: 'flex',
                                    alignItems: 'center',
