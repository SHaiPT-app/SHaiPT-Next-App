...
const ITEMS: { q: string; a: string }[] = [
    {
        ...
        a: 'Bench press, squat, deadlift, lateral raise and barbell curl. The bench press is measured in 3D when the body scan runs; from the foot end of a bench, angles that cannot be read in 2D are left unscored rather than guessed.',
    },
    {
