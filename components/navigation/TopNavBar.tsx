...
export function TopNavBar({ userName, avatarUrl, notificationCount = 0 }: TopNavBarProps) {
    ...
    return (
        <header className="hidden md:block fixed top-0 left-0 right-0 z-50">
            <div className="border-b border-line-soft bg-[rgba(21,21,31,0.85)] backdrop-blur-xl">
                                ...
                                return (
                                    <button
                                        ...
                                        className={`
                                            ...
                                            ${active
                                                ? 'text-brand'
                                                : 'text-ink-low hover:text-ink-mid hover:bg-white/5'
                                            }
                                        `}
                                    >
                                        ...
                                        {active && (
                                            <motion.div
                                                ...
                                                className="absolute bottom-0 left-2 right-2 h-0.5 rounded-full bg-brand shadow-[0_0_8px_var(--brand-glow)]"
                                                initial={false}
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            {workout.isActive ? (
                                ...
                                <motion.button
                                    ...
                                    className="px-4 py-2 rounded-full bg-[image:var(--brand-gradient)]
                                             text-white font-semibold flex items-center gap-2 shadow-lg shadow-[var(--brand-glow-soft)]"
                                >
                            ...
                            <button
                                ...
                                className="relative p-2 rounded-lg text-ink-low hover:text-ink-mid hover:bg-white/5"
                            >
                            ...
                            <button
                                ...
                                className="w-9 h-9 rounded-full overflow-hidden border-2 border-line-strong hover:border-brand transition-colors"
                            >
                                {avatarUrl ? (
                                    <img
                                        src={avatarUrl}
                                    ...
                                    <div className="w-full h-full bg-[image:var(--brand-gradient)] flex items-center justify-center">
