...
import HealthWaiver from '@/components/ai-coach/HealthWaiver';
        ...
        <div className="flex h-dvh max-h-dvh flex-col overflow-hidden text-ink-hi">
            ...
            <div className="flex flex-1 flex-col overflow-hidden">
                ...
                {flowStage === 'waiver' && !waiverLoading && (
                    <HealthWaiver accepted={waiverAccepted} onAcceptedChange={setWaiverAccepted} onAccept={handleAcceptWaiver} />
                )}
                ...
                {/* Later stages. Hidden during the waiver too: as a second flex-1 child it used to take half the
                    screen while empty, leaving the waiver squeezed into the top half with black below. */}
                <div
                    className={`flex-1 overflow-auto ${
                        flowStage === 'waiver' || (showInterviewTabs && flowStage === 'interview') ? 'hidden' : 'block'
                    }`}
                >
