        ...
        <div style={{
            ...
            >
                ...
                <div style={{
                    ...
                    <h3 style={{ fontSize: '1rem', fontWeight: 600, color: '#da0023', margin: 0 }}>
                ...
                <div style={{ padding: '0.75rem 1.25rem', display: 'flex', gap: '0.5rem' }}>
                    <button
                        ...
                        style={{
                            ...
                            background: !customMode ? 'rgba(218,0,35,0.15)' : 'rgba(255,255,255,0.05)',
                            color: !customMode ? '#da0023' : '#888', fontWeight: 500, fontSize: '0.85rem',
                        }}
                    >
                        Search Food
                    </button>
                            ...
                            {results.map(food => (
                                <button
                                    ...
                                    style={{
                                        width: '100%',
                                        padding: '0.75rem',
                                        background: selectedFood?.id === food.id ? 'rgba(218,0,35,0.08)' : 'transparent',
                                        border: `1px solid ${selectedFood?.id === food.id ? 'rgba(218,0,35,0.3)' : 'rgba(255,255,255,0.04)'}`,
                                        borderRadius: '8px',
                                        color: '#e5e5e7',
                                        cursor: 'pointer',
                                        textAlign: 'left',
                                ...
                                >
                                    ...
                                    <div style={{ fontSize: '0.75rem', color: '#888', display: 'flex', gap: '0.75rem' }}>
                                        ...
                                        <span style={{ color: '#da0023' }}>P: {food.protein_g}g</span>
                                        <span style={{ color: '#da0023' }}>C: {food.carbs_g}g</span>
                                        <span style={{ color: '#ff3352' }}>F: {food.fat_g}g</span>
                                    </div>
                                </button>
                            ))}
                        </div>
                    ...
                    <div style={{ flex: 1, overflowY: 'auto', padding: '0 1.25rem 1.25rem' }}>
                        <div style={{ display: 'grid', gap: '0.75rem' }}>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '0.5rem' }}>
                                <div>
                                    <label style={{ fontSize: '0.75rem', color: '#da0023', display: 'block', marginBottom: '0.25rem' }}>Protein (g)</label>
                                    <input
                                ...
                                <div>
                                    <label style={{ fontSize: '0.75rem', color: '#da0023', display: 'block', marginBottom: '0.25rem' }}>Carbs (g)</label>
                                    <input
                                ...
                                <div>
                                    <label style={{ fontSize: '0.75rem', color: '#ff3352', display: 'block', marginBottom: '0.25rem' }}>Fat (g)</label>
                                    <input
                            ...
                            <button
                                ...
                                style={{
                                    padding: '0.75rem',
                                    background: customFood.name ? '#da0023' : 'rgba(218,0,35,0.3)',
                                    color: '#000',
                                    border: 'none',
                                    borderRadius: '8px',
                                    fontWeight: 600,
                ...
                >
                    <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        <div style={{ fontSize: '0.7rem', color: '#666', display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
                            ...
                            <span style={{ color: '#da0023' }}>P: {Math.round(log.protein_g)}g</span>
                            <span style={{ color: '#da0023' }}>C: {Math.round(log.carbs_g)}g</span>
                            <span style={{ color: '#ff3352' }}>F: {Math.round(log.fat_g)}g</span>
                        </div>
                    </div>
    ...
    return (
        <div style={{ maxWidth: '600px', margin: '0 auto', padding: '2rem 1rem' }}>
            ...
            <div style={{ marginBottom: '1.5rem' }}>
                <h1 style={{ fontSize: '1.5rem', fontWeight: 700, color: '#da0023', marginBottom: '0.25rem' }}>
                    Macro Tracking
                </h1>
            ...
            <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.75rem' }}>
                    <Target size={16} style={{ color: '#da0023' }} />
