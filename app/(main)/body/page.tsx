...
function TrendIndicator({ current, previous }: { current?: number; previous?: number }) {
    ...
    if (diff > 0) return <TrendingUp size={14} style={{ color: '#da0023' }} />;
    return <TrendingDown size={14} style={{ color: '#ff3352' }} />;
}
    ...
    return (
        <button
            ...
            onMouseEnter={(e) => {
                ...
                e.currentTarget.style.borderColor = 'rgba(218, 0, 35, 0.3)';
            }}
            onMouseLeave={(e) => {
                ...
                {media.url ? (
                    media.media_type === 'video' ? (
                        <div style={{
                            ...
                            <Video size={32} style={{ color: '#da0023' }} />
                        </div>
                    ) : (
                        <img
                            src={media.url}
    ...
    if (loading) {
        return (
            <div style={{
                ...
                <Loader2 size={32} style={{ color: '#da0023', animation: 'spin 1s linear infinite' }} />
            </div>
        );
    }
                ...
                {(['measurements', 'photos'] as const).map((tab) => (
                    <button
                        ...
                        style={{
                            ...
                            borderRadius: '10px',
                            border: 'none',
                            background: activeTab === tab ? 'rgba(218, 0, 35, 0.15)' : 'transparent',
                            color: activeTab === tab ? '#da0023' : 'rgba(255,255,255,0.5)',
                            fontWeight: 600,
                            fontSize: '0.9rem',
                            cursor: 'pointer',
                            transition: 'all 0.2s',
            ...
            {!error && activeTab === 'measurements' && (
                <div>
                        ...
                        >
                            ...
                            {latestMeasurement.weight_kg !== undefined && (
                                <div style={{
                                    ...
                                    <Scale size={20} style={{ color: '#da0023' }} />
                                    <span style={{ fontSize: '2rem', fontWeight: 800, color: '#da0023' }}>
                                    ...
                                    {previousMeasurement?.weight_kg !== undefined && latestMeasurement.weight_kg !== undefined && (
                                        <span style={{
                                            fontSize: '0.8rem',
                                            color: latestMeasurement.weight_kg - previousMeasurement.weight_kg > 0 ? '#ff3352' : '#da0023',
                                        }}>
                    ...
                    <button
                        ...
                        onMouseEnter={(e) => {
                            e.currentTarget.style.background = 'rgba(218, 0, 35, 0.2)';
                        }}
                        onMouseLeave={(e) => {
                                                    ...
                                                    <div>
                                                        ...
                                                        <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
                                                            {m.weight_kg !== undefined && (
                                                                <span style={{ fontSize: '0.8rem', color: '#da0023' }}>
                ...
                <div>
                    ...
                    <button
                        ...
                        style={{
                            width: '100%',
                            padding: '1rem',
                            background: uploading ? 'rgba(255,255,255,0.05)' : 'rgba(218, 0, 35, 0.1)',
                            border: `1px solid ${uploading ? 'rgba(255,255,255,0.1)' : 'rgba(218, 0, 35, 0.3)'}`,
                            borderRadius: '12px',
                            color: uploading ? 'rgba(255,255,255,0.4)' : '#da0023',
                            fontSize: '0.95rem',
                            fontWeight: 600,
