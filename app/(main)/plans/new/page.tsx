...
const PHASE_OPTIONS: { value: PhaseType; label: string; icon: typeof Dumbbell; color: string }[] = [
    { value: 'hypertrophy', label: 'Hypertrophy', icon: Dumbbell, color: '#da0023' },
    { value: 'strength', label: 'Strength', icon: Target, color: '#ff3352' },
    { value: 'endurance', label: 'Endurance', icon: Zap, color: '#da0023' },
            ...
            {showSharePanel && (
                <div className="glass-panel" style={{
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <div>
                            <p style={{ color: '#da0023', fontWeight: 600, marginBottom: '0.25rem' }}>
                ...
                <div style={{
                    ...
                    <button
                        ...
                        style={{
                            ...
                            border: 'none',
                            cursor: 'pointer',
                            background: creationMode === 'manual' ? 'rgba(218, 0, 35, 0.15)' : 'transparent',
                            color: creationMode === 'manual' ? '#da0023' : '#888',
                    ...
                    <button
                        ...
                        style={{
                            ...
                            border: 'none',
                            cursor: 'pointer',
                            background: creationMode === 'ai' ? 'rgba(218, 0, 35, 0.15)' : 'transparent',
                            color: creationMode === 'ai' ? '#da0023' : '#888',
                    ...
                    <div style={{ display: 'grid', gap: '1rem' }}>
                        ...
                        <button
                            ...
                            style={{
                                ...
                                borderRadius: '10px',
                                border: 'none',
                                background: aiGenerating ? 'rgba(218, 0, 35, 0.1)' : '#da0023',
                                color: aiGenerating ? '#da0023' : '#000',
                                fontWeight: 700,
                                fontSize: '1rem',
                        ...
                        <div style={{ display: 'grid', gap: '1rem' }}>
                            ...
                            <div style={{ display: 'flex', gap: '1.5rem', flexWrap: 'wrap' }}>
                                <label style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', cursor: 'pointer', color: '#ccc', fontSize: '0.9rem' }}>
                                    <input type="checkbox" checked={isTemplate} onChange={(e) => setIsTemplate(e.target.checked)} style={{ accentColor: '#da0023' }} />
                                    Save as Template
                                </label>
                                <label style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', cursor: 'pointer', color: '#ccc', fontSize: '0.9rem' }}>
                                    <input type="checkbox" checked={isPublic} onChange={(e) => setIsPublic(e.target.checked)} style={{ accentColor: '#da0023' }} />
                                    Public
                                </label>
                                <label style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', cursor: 'pointer', color: '#ccc', fontSize: '0.9rem' }}>
                                    <input type="checkbox" checked={isShareable} onChange={(e) => setIsShareable(e.target.checked)} style={{ accentColor: '#da0023' }} />
                                    Shareable
                                </label>
                            </div>
                        </div>
                    ...
                    <div className="glass-panel" style={{ padding: '1.5rem', marginBottom: '1.5rem' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
                            <h3 style={{
                                ...
                                <span style={{
                                    background: '#da0023', color: '#000', borderRadius: '50%',
                            ...
                            {sessions.map((session) => {
                                ...
                                return (
                                    <div key={session.id} style={{
                                        border: isExpanded ? '1px solid rgba(218, 0, 35, 0.2)' : '1px solid rgba(255,255,255,0.06)',
                                        borderRadius: '12px', overflow: 'hidden',
                                        background: isExpanded ? 'rgba(218, 0, 35, 0.03)' : 'rgba(255,255,255,0.02)',
                                        transition: 'all 0.2s',
                                    }}>
                                        {/* Session Header */}
                                        <div
                                        ...
                                        >
                                            <div style={{
                                                ...
                                                background: 'rgba(218, 0, 35, 0.15)', color: '#da0023',
                                        ...
                                        {isExpanded && (
                                            <div style={{ padding: '0 1rem 1rem', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
                                                            ...
                                                            <div style={{ display: 'grid', gap: '0.25rem' }}>
                                                                ...
                                                                {exercise.sets.map((set, setIdx) => (
                                                                    <div key={setIdx} style={{
                                                                        ...
                                                                        <span style={{ color: '#da0023', fontWeight: 600, fontSize: '0.8rem' }}>{setIdx + 1}</span>
                                                                        <input
                                                ...
                                                <button onClick={() => addExercise(session.id)} style={{
                                                    ...
                                                    background: 'rgba(255,255,255,0.03)', border: '1px dashed rgba(255,255,255,0.1)',
                                                    borderRadius: '8px', color: '#da0023', cursor: 'pointer', fontSize: '0.85rem',
                                                    display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.25rem',
                                                }}>
                                                    <Plus size={14} />
                                                    Add Exercise
                        ...
                        <button onClick={addSession} style={{
                            ...
                            background: 'rgba(218, 0, 35, 0.08)', border: '1px dashed rgba(218, 0, 35, 0.2)',
                            borderRadius: '10px', color: '#da0023', cursor: 'pointer', fontSize: '0.9rem',
            ...
            <div style={{ position: 'fixed', bottom: '2rem', right: '2rem', zIndex: 100 }}>
                <button
                    ...
                    style={{
                        ...
                        background: saving ? 'rgba(218, 0, 35, 0.1)' : '#da0023',
                        color: saving ? '#da0023' : '#000',
                        border: 'none',
                        cursor: (saving || !planName.trim() || sessions.length === 0) ? 'not-allowed' : 'pointer',
                        boxShadow: '0 4px 20px rgba(218, 0, 35, 0.3)',
                        transition: 'all 0.2s',
